            ...
            <ul aria-label="primary navigation links" class="navbar-nav align-items-lg-center text-uppercase pt-3 pt-lg-0 ml-auto">
               ...
               <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Turf Removal<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/overview">Program Overview</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/eligibility">Program Eligibility</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/process">Participation Process</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/terms">Program Terms and Conditions</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/ldap">Design Consultation</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/turf/lmap">Maintenance Consultation</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/start">Apply Now</a></li>
                  </ul>
               </li>
               <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Spray to Drip<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                     <li><a href="https://mwdoc.dropletportal.com/rebate/drip/overview">Program Overview</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/drip/eligibility">Program Eligibility</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/drip/process">Participation Process</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/drip/terms">Program Terms and Conditions</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/public/documents/Rebate_Elig_Product_List_2021.pdf" target="_blank">Qualified Drip List</a></li>
                     <li><a href="/public_documents/Drip_Tubing_Fact_Sheet.pdf" target="_blank">Drip Tubing Fact Sheet</a></li>
                     <li><a href="/public_documents/Drip_Tubing_Kit_Parts_List.pdf" target="_blank">Example of a Drip Tubing Component Bundle</a></li>
                     <li><a href="/public_documents/Photos_of_Non-Qualifying_Drip_Equipment.pdf" target="_blank">Samples of Non Eligible Equipment</a></li>
                     <li><a href="https://mwdoc.dropletportal.com/rebate/start">Apply Now</a></li>
                  </ul>
               </li>
               <li class="resources-link"><a href="https://mwdoc.dropletportal.com/rebate/program/resources">Resources</a></li>
               <li class="support-link"><a href="https://mwdoc.dropletportal.com/program/support">Support</a></li>
               <% If Session("MM_UserAuthorization") = "" Then %>
               <li class="sign-in-link mr-3"><a href="https://mwdoc.dropletportal.com/secure/login/logout.asp">Sign In</a></li>
               <% Else %>
               <li class="sign-in-link mr-3"><a href="https://mwdoc.dropletportal.com/secure/login/logout.asp">Sign Out</a></li>
               <% End If %>
               ...
               <li class="masquerade-link"><a href="https://mwdoc.dropletportal.com/secure/program_manager/masquerade/"><i class="fa fa-refresh" aria-hidden="true"></i> End Masquerade</a></li>
               <% End if %>
            </ul>
         </div>
      </nav>
